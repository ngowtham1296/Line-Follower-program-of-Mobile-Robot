...
DataOut = 23
    ...
    """
    A class is defined for Tracking sensor and under that several
    functions for sensor calibration, sensor read line, sensor read calibrated
    are defined to calibrate and track the black lines out of white line.
    """
class TRSensor(object):
    ...
    with higher values corresponding to lower reflectance.
    """
    def AnalogRead(self):
        value = [0,0,0,0,0,0]
...
def updateEncoderR(channel):
    ...
    """
    Definition for the encoders to record the number of turns travelled
    by the left and right and wheels.
    """
